...
// Mock data - en Nuxt podrías obtener esto de una API o pinia store
const mockVineyards: any = [
  // ... tus datos de viñedos mockeados
];

const featuredVineyards = mockVineyards.slice(0, 3);
const highlightedVineyards = mockVineyards.slice(0, 6);
