      ...
      <div class="text-center">
        ...
        <div class="mt-8 mb-8">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <!-- Cliente Button -->
            <div class="relative">
              <input id="customer" type="radio" name="accountType" value="customer" checked readonly class="sr-only">
              <label for="customer"
                ...
                <div
                  class="w-16 h-16 bg-burgundy-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <NuxtLink to="/auth/register/vineyard" class="relative">
              <div
                ...
                <div
                  class="w-16 h-16 bg-gold-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <p class="mt-4 text-sm text-gray-600">
          ...
          <NuxtLink to="/auth/login" class="font-medium text-burgundy-600 hover:text-burgundy-500 ml-1">
            {{ $t('navigation.login') }}
          </NuxtLink>
        </p>
      </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="mt-1 relative">
                ...
                <input id="phone" v-model="formData.phone" name="phone" type="tel"
                  class="appearance-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-burgundy-500 focus:border-burgundy-500 sm:text-sm"
            ...
            <div>
              ...
              <input id="birthDate" v-model="formData.birthDate" name="birthDate" type="date"
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="mt-1 relative">
                ...
                <input id="password" v-model="formData.password" name="password"
            ...
            <div>
              ...
              <div class="grid grid-cols-2 gap-2">
                <label v-for="type in wineTypes" :key="type.value"
                  class="flex items-center space-x-2 p-2 border border-gray-200 rounded-md hover:bg-gray-50 cursor-pointer">
                  <input type="checkbox" :checked="formData.preferences.wineTypes.includes(type.value)"
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2">
                <label class="flex items-center space-x-2">
                  <input v-model="formData.preferences.notifications" type="checkbox"
                    class="rounded border-gray-300 text-burgundy-600 focus:ring-burgundy-500">
